...
<body>
    ...
    <div class="mid">
        <h1> Welcome <strong> <?php echo "HOD"; ?></strong><h1> 
    </div>
    ...
    <div class="right">
            <ul class="navbar">
                ...
                <li><a href="hod_leave.php">APPLY FOR LEAVE </a></li>
...
<!-- if the user logged in then print information -->
    <?php if(isset($_SESSION['User'])) : ?>
        ...
        <?php  $u = $_SESSION['User'];
             $sql = "SELECT User,Name,Branch,leave_days FROM `hod` WHERE `User`= '$u'";
        ...
        <p class="btn"><a href="hod.php?logout='1'" 
