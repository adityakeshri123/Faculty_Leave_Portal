...
<body>
    ...
    <div class="mid">
        <h1> Welcome <strong> <?php echo "Director" ?></strong><h1> 
...
<!-- if the user logged in then print information -->
    <?php if(isset($_SESSION['User'])) : ?>
        ...
        <?php  $u = $_SESSION['User'];
             $sql = "SELECT User,Name,Branch FROM `director` WHERE `User`= '$u'";
        ...
        <!-- <p> <strong>Number of Leave Days Available: <?php // echo $_SESSION['leave_days']; ?></p> -->
        <p class="btn"><a href="director.php?logout='1'" 
  ...
  <div class="right">
            <ul class="navbar">
                ...
                <li><a href="selecthod.php">SELECT HOD</a></li>
