...
<head>
    ...
    <title>DEAN_LEAVE_RECIEVED_Page</title>
</head>
<style>
body{
    margin: 0px;
...
<header class="header">
        ...
        <div class="mid">
           <ul class="navbar">
               ...
               <li><a href="dean_respond_comment.php">ADD COMMENT</a></li>
           </ul>
       </div>
   </header>

   <div class ="top">
    <?php if(isset($_SESSION['msg10'])) : ?>
            <h3>
                <?php
                    echo $_SESSION['msg10'];
...
<table class="content_table">
    ...
    <?php
        ...
        hod_approve,dean_comment,dean_approve,Status FROM faculty_leave WHERE hod_approve ='YES'";
        ...
        if(mysqli_num_rows($result)>0){
            while($row=mysqli_fetch_assoc($result)){
                ...
                .$row["end_date"]."</td><td>"
                .$row["faculty_comment"]."</td><td>"
                .$row["hod_comment"]."</td><td>"
                .$row["hod_approve"]."</td><td>"
                .$row["dean_comment"]."</td><td>"
                .$row["dean_approve"]."</td></tr>";
                }
                echo "</table>";
            }
        ?>
