...
<head>
    ...
    <title>HOD_LEAVE_RECIEVED_Page</title>
</head>
<style>
body{
    margin: 0px;
...
<header class="header">
        ...
        <div class="mid">
           <ul class="navbar">
               ...
               <li><a href="hod_respond_comment.php">ADD COMMENT</a></li>
           </ul>
       </div>
   </header>
...
<table class="content_table">
    ...
    <?php
        ...
        hod_approve,dean_comment,dean_approve,Status FROM faculty_leave WHERE Branch='$branch'";
