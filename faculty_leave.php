...
<head>
    ...
    <title>Faculty_Leave_Page</title>
</head>
<style>
body{
    margin: 0px;
   ...
   <div class="top">
    ...
    <div class="container">
        ...
        <form action="faculty_leave.php" method="post">
                ...
                <textarea class="text" name="faculty_comment" id="faculty_comment" cols="200" rows="10"
              ...
              <button class="btn" name ="faculty_apply" type="submit">APPLY</button>
