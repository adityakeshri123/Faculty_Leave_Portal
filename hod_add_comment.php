...
<head>
    ...
    <title>HOD_EDIT_COMMENT_PAGE</title>
</head>
<style>
body{
    margin: 0px;
...
<body>
    <header class="header">
        ...
        <div class="mid">
           <ul class="navbar">
               ...
               <li><a href="hod_leave_status.php">LEAVE APPLICATION STATUS</a></li>
   ...
   <div class="top">
    ...
    <div class="container">
        <h1>ADD COMMENT</h1>
        <form action="hod_add_comment.php" method="post">
        ...
        <input type="text" name="User" required id="User" placeholder="Enter Your User name">
            ...
            <button class="btn" name ="hod_comment_add" type="submit">ADD</button>
