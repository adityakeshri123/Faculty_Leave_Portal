...
<header class="header">
    ...
    <div class ="top">
    <?php if(isset($_SESSION['error_dean'])) : ?>
            <h3>
                <?php
                    echo $_SESSION['error_dean'];
                    unset($_SESSION['error_dean']);
                ?>
            <h3>
        <?php endif ?>
    </div>
<div class="container">
        <h1>SELECT DEAN</h1>
        <form action="selectdean.php" method="post">
        ...
        <?php //include('errors.php') ?>
            ...
            <button class="btn" name ="appointdean" type="submit">Appoint</button>
